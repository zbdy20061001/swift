...
/**
 * <p>SeqE2_F92a_WITL_Type complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="SeqE2_F92a_WITL_Type">
 *   &lt;complexContent>
 ...
 *         &lt;element name="F92R" type="{urn:swift:xsd:fin.564.2018}F92R_1_Type"/>
 *       &lt;/choice>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SeqE2_F92a_WITL_Type", propOrder = {
    "f92A",
    "f92F",
    "f92K",
    "f92R"
})
public class SeqE2F92AWITLType
    extends Qualifier
{
     ...
     *     
     */
    public void setF92R(F92R1Type value) {
        this.f92R = value;
    }
