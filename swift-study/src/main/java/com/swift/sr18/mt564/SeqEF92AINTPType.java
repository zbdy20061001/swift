...
/**
 * <p>SeqE_F92a_INTP_Type complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="SeqE_F92a_INTP_Type">
 *   &lt;complexContent>
 ...
 *         &lt;element name="F92J" type="{urn:swift:xsd:fin.564.2018}F92J_15_Type"/>
...
@XmlType(name = "SeqE_F92a_INTP_Type", propOrder = {
    "f92A",
    "f92F",
    "f92J",
    "f92K"
})
public class SeqEF92AINTPType
    extends Qualifier
{
     ...
     *     
     */
    public void setF92J(F92J15Type value) {
        this.f92J = value;
    }
