...
/**
 * <p>SeqE2_F90a_PRPP_Type complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="SeqE2_F90a_PRPP_Type">
 *   &lt;complexContent>
 ...
 *         &lt;element name="F90K" type="{urn:swift:xsd:fin.564.2018}F90K_Type"/>
 *       &lt;/choice>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SeqE2_F90a_PRPP_Type", propOrder = {
    "f90A",
    "f90B",
    "f90E",
    "f90K"
})
public class SeqE2F90APRPPType
    extends Qualifier
{
    ...
    @XmlElement(name = "F90K")
    protected F90KType f90K;
     ...
     *     
     */
    public void setF90K(F90KType value) {
        this.f90K = value;
    }
