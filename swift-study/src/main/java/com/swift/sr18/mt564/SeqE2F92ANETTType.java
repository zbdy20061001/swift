...
/**
 * <p>SeqE2_F92a_NETT_Type complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="SeqE2_F92a_NETT_Type">
 *   &lt;complexContent>
 ...
 *         &lt;element name="F92J" type="{urn:swift:xsd:fin.564.2018}F92J_27_Type"/>
...
@XmlType(name = "SeqE2_F92a_NETT_Type", propOrder = {
    "f92F",
    "f92H",
    "f92J",
    "f92K"
})
public class SeqE2F92ANETTType
    extends Qualifier
{
     ...
     *     
     */
    public void setF92J(F92J27Type value) {
        this.f92J = value;
    }
