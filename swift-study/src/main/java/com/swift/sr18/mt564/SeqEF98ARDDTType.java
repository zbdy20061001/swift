...
/**
 * <p>SeqE_F98a_RDDT_Type complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="SeqE_F98a_RDDT_Type">
 *   &lt;complexContent>
 ...
 *         &lt;element name="F98F" type="{urn:swift:xsd:fin.564.2018}F98F_1_Type"/>
 *       &lt;/choice>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SeqE_F98a_RDDT_Type", propOrder = {
    "f98A",
    "f98B",
    "f98C",
    "f98E",
    ...
    extends Qualifier
{
    ...
    @XmlElement(name = "F98F")
    protected F98F1Type f98F;
     ...
     *     
     */
    public void setF98F(F98F1Type value) {
        this.f98F = value;
    }
